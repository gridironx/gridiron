...
import (
	...
	"github.com/gridiron/ethermint/x/evm"
	evmkeeper "github.com/gridiron/ethermint/x/evm/keeper"
	evmtypes "github.com/gridiron/ethermint/x/evm/types"
	"github.com/gridiron/ethermint/x/evm/vm/geth"
	"github.com/gridiron/ethermint/x/feemarket"
	feemarketkeeper "github.com/gridiron/ethermint/x/feemarket/keeper"
	feemarkettypes "github.com/gridiron/ethermint/x/feemarket/types"

	// unnamed import of statik for swagger UI support
	_ "github.com/gridiron/gridiron/v11/client/docs/statik"

	"github.com/gridiron/gridiron/v11/app/ante"
	v10 "github.com/gridiron/gridiron/v11/app/upgrades/v10"
	v11 "github.com/gridiron/gridiron/v11/app/upgrades/v11"
	v8 "github.com/gridiron/gridiron/v11/app/upgrades/v8"
	v81 "github.com/gridiron/gridiron/v11/app/upgrades/v8_1"
	v82 "github.com/gridiron/gridiron/v11/app/upgrades/v8_2"
	v9 "github.com/gridiron/gridiron/v11/app/upgrades/v9"
	v91 "github.com/gridiron/gridiron/v11/app/upgrades/v9_1"
	"github.com/gridiron/gridiron/v11/x/claims"
	claimskeeper "github.com/gridiron/gridiron/v11/x/claims/keeper"
	claimstypes "github.com/gridiron/gridiron/v11/x/claims/types"
	"github.com/gridiron/gridiron/v11/x/epochs"
	epochskeeper "github.com/gridiron/gridiron/v11/x/epochs/keeper"
	epochstypes "github.com/gridiron/gridiron/v11/x/epochs/types"
	"github.com/gridiron/gridiron/v11/x/erc20"
	erc20client "github.com/gridiron/gridiron/v11/x/erc20/client"
	erc20keeper "github.com/gridiron/gridiron/v11/x/erc20/keeper"
	erc20types "github.com/gridiron/gridiron/v11/x/erc20/types"
	"github.com/gridiron/gridiron/v11/x/incentives"
	incentivesclient "github.com/gridiron/gridiron/v11/x/incentives/client"
	incentiveskeeper "github.com/gridiron/gridiron/v11/x/incentives/keeper"
	incentivestypes "github.com/gridiron/gridiron/v11/x/incentives/types"
	"github.com/gridiron/gridiron/v11/x/inflation"
	...
	"github.com/gridiron/gridiron/v11/x/recovery"
	recoverykeeper "github.com/gridiron/gridiron/v11/x/recovery/keeper"
	recoverytypes "github.com/gridiron/gridiron/v11/x/recovery/types"
	"github.com/gridiron/gridiron/v11/x/revenue"
	revenuekeeper "github.com/gridiron/gridiron/v11/x/revenue/keeper"
	revenuetypes "github.com/gridiron/gridiron/v11/x/revenue/types"
	"github.com/gridiron/gridiron/v11/x/vesting"
	vestingkeeper "github.com/gridiron/gridiron/v11/x/vesting/keeper"
	vestingtypes "github.com/gridiron/gridiron/v11/x/vesting/types"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/gridiron/gridiron/v11/x/ibc/transfer"
	transferkeeper "github.com/gridiron/gridiron/v11/x/ibc/transfer/keeper"
)
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".gridirond")

	// manually update the power reduction by replacing micro (u) -> atto (a) gridiron
