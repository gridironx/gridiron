...
Say, there are several incentives that have registered an allocation for the $GRIDIRON coin and the allocation meter for $GRIDIRON is at 97%. Then a new incentve proposal can only include an $GRIDIRON allocation at up to 3%, claiming the last remaining allocation capcaity from the $GRIDIRON rewards in the inflation pool.
