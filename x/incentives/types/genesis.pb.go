...
// source: gridiron/incentives/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "gridiron.incentives.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "gridiron.incentives.v1.Params")
}

func init() { proto.RegisterFile("gridiron/incentives/v1/genesis.proto", fileDescriptor_7bb1f7c7e8ad160b) }
