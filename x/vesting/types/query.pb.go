...
func init() {
	proto.RegisterType((*QueryBalancesRequest)(nil), "gridiron.vesting.v1.QueryBalancesRequest")
	proto.RegisterType((*QueryBalancesResponse)(nil), "gridiron.vesting.v1.QueryBalancesResponse")
}

func init() { proto.RegisterFile("gridiron/vesting/v1/query.proto", fileDescriptor_ff0457b141ab5d28) }
...
func (c *queryClient) Balances(ctx context.Context, in *QueryBalancesRequest, opts ...grpc.CallOption) (*QueryBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridiron.vesting.v1.Query/Balances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridiron.vesting.v1.Query/Balances",
	}
