...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "gridiron.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "gridiron.inflation.v1.ExponentialCalculation")
}
