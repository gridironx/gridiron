...
## Gridiron Token Model

The Gridiron Token Model outlines how the Gridiron network is secured through a
...
issue 1 billion Gridiron tokens within the first 4 years.
...
daily provision (`epochProvison`) of Gridiron tokens is minted and allocated to staking rewards,
