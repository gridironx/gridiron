...
The `x/inflation` module mints new Gridiron tokens and allocates them in daily
epochs according to the [Gridiron Token
Model](https://gridiron.blog/the-gridiron-token-model-edc07014978b) distribution to
...
The allocation of new coins incentivizes specific behaviour in the Gridiron
