...
// source: gridiron/epochs/v1/genesis.proto
...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "gridiron.epochs.v1.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "gridiron.epochs.v1.GenesisState")
}

func init() { proto.RegisterFile("gridiron/epochs/v1/genesis.proto", fileDescriptor_c74bc0b3e7fa01c2) }
