...
* The transactions eligible are only [EVM transactions](https://docs.gridiron.org/modules/evm/) (`MsgEthereumTx`). Cosmos SDK transactions are not eligible at this time.
