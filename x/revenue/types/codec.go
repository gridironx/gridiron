...
const (
	// Amino names
	cancelRevenueName   = "gridiron/MsgCancelRevenue"
	registerRevenueName = "gridiron/MsgRegisterRevenue"
	updateRevenueName   = "gridiron/MsgUpdateRevenue"
	updateParamsName    = "gridiron/MsgUpdateParams"
)
