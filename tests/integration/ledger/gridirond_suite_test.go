...
import (
	...
	clientkeys "github.com/gridiron/ethermint/client/keys"
	feemarkettypes "github.com/gridiron/ethermint/x/feemarket/types"
	gridironkeyring "github.com/gridiron/gridiron/v11/crypto/keyring"
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = gridironkeyring.SupportedAlgorithms
		options.SupportedAlgosLedger = gridironkeyring.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = gridironkeyring.CreatePubkey
		options.LedgerAppName = gridironkeyring.AppName
		options.LedgerSigSkipDERConv = gridironkeyring.SkipDERConversion
	}
}
