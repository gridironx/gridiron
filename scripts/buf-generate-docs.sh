...
# also make sure that you are added to the Gridiron organization on buf
...
buf mod update $GRIDIRONPROTO

# then, push the gridiron proto module and documentation 
buf push $GRIDIRONPROTO

# two commit addresses should be printed to the command line
# the gridiron documentation will have links to the third party documentation
