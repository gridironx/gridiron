...
# Initialize chain.
gridirond init test --chain-id gridiron_9000-2

# Get Genesis
wget https://archive.gridiron.org/mainnet/genesis.json
mv genesis.json ~/.gridirond/config/

wget -O ~/.gridirond/config/adrbook.json https://snapshot.notional.ventures/gridiron/addrbook.json
...
export GRIDIROND_STATESYNC_RPC_SERVERS="https://gridiron-rpc.polkachu.com:443,https://rpc-gridiron-ia.notional.ventures:443"
