...
gridirond keys add dev0
{
  "name": "dev0",
  "type": "local",
  "address": "gridiron1n253dl2tgyhxjm592p580c38r4dn8023ctv28d",
...
```bash
$ gridirond keys add dev0-restored --recover
...
```bash
gridirond keys unsafe-export-eth-key dev0 > dev0.export
...
```bash
$ gridirond keys import dev0-imported ./dev0.export
Enter passphrase to decrypt your key:
```
...
```
$ gridirond keys unsafe-import-eth-key dev0-imported ./dev0.export
