...
Learn more about transactions on Gridiron {synopsis}
...
<!-- 
TODO: explain what transactions are on Gridiron and blockchains. 
...
<!-- TODO: explain which transactions types does Gridiron support (i.e modules and changes) and provide a few examples. -->
...
Gridiron supports the following Ethereum transactions.
