...
Learn about the encoding formats used on Gridiron. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Gridiron does not
...
allows for quick reconstruction of encoded data. Gridiron uses RLP to encode/decode Ethereum
