...
Learn about Gridiron and its primary features. {synopsis}
...
Gridiron allows for running vanilla Ethereum as a [Cosmos](https://cosmos.network/)
...
Here’s a glance at some of the key features of Gridiron:
...
Gridiron enables these key features by:
...
| Property               | Value                                                      |
| ---------------------- | ---------------------------------------------------------- |
| Gridiron Testnet          | `{{ $themeConfig.project.testnet_chain_id }}`              |
| Gridiron Mainnet          | `{{ $themeConfig.project.chain_id }}`                      |
