...
preparing test network with chain-id "gridiron_1276974-1"
...
```bash
gridirond keys add test --recover
```

Check the balance of the account address:

```bash
gridirond q bank balances ADDRESS
```
